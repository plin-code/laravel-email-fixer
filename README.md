# Sanitize, normalize and auto-correct malformed email addresses in Laravel
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-email-fixer.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-email-fixer)
...
```bash
php artisan vendor:publish --tag="laravel-email-fixer-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-email-fixer-views"
```

## Usage

```php
$laravelEmailFixer = new PlinCode\LaravelEmailFixer();
echo $laravelEmailFixer->echoPhrase('Hello, PlinCode!');
```
